...
public class JTrainingSettingsPanel extends JPanelBase {
	...
	private void initView(){
		...
		JLabel lblStartTrainingInfo = new CLabel("Training Settings",getMainFont());
		...
		JLabel lblRepeatVocablesNot = new CLabel("repeat vocables not trained since",getMainFont());
		...
		JLabel lblDays_1 = new CLabel("days",getMainFont());
		panel_7.add(lblDays_1, "cell 3 1");
		
		JLabel lblShowEveryVocable = new CLabel("Show every vocable at least",getMainFont());
		...
		panel_7.add(new CLabel("Test mode ",getMainFont()), "cell 0 3");
		panel_7.add(comboTrainerMode, "cell 1 3");
		
		JLabel lblTimes = new CLabel("times",getMainFont());
		panel_7.add(lblTimes, "cell 1 2");
		
		CButton btnStart = new CButton("Start",getMainFont());
		...
		CButton btnCancelTrainingSettings = new CButton("Cancel",getMainFont());
